...
for pop_it in [15, 30]:
    ...
    for seed_it in range(10):
        ...
        df_fitness_objectives[f'Seed {seed_it} pop {pop_it}'] = fitness_save
        df_best_objective[f'Seed {seed_it} pop {pop_it}'] = best_objective_save


    df_fitness_objectives.to_excel(f'PSO_HW6/results/fitness_total_v9_{pop_it}.xlsx', index = False)
    df_best_objective.to_excel(f'PSO_HW6/results/best_objectives_v9_{pop_it}.xlsx', index = False)